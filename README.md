...
The current public npm package is `boardreadyops@1.8.4`. It is verified on
Node.js 22.14+ and 24, includes the current CLI bundle, schemas, docs, Action
metadata, and matches the public `v1.8.4` tag archive.
Binary release assets should be verified against `v1.8.4`, which publishes the
