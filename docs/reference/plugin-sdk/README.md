...
- [PluginFixSuggestion](interfaces/PluginFixSuggestion.md)
- [PluginLogger](interfaces/PluginLogger.md)
- [PluginProjectContext](interfaces/PluginProjectContext.md)
- [PluginRuleContext](interfaces/PluginRuleContext.md)
